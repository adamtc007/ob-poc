...
ALTER SCHEMA custody OWNER TO postgres;
...
ALTER SCHEMA kyc OWNER TO postgres;
...
ALTER SCHEMA "ob-poc" OWNER TO postgres;
...
ALTER FUNCTION custody.find_ssi_for_trade(p_cbu_id uuid, p_instrument_class_id uuid, p_security_type_id uuid, p_market_id uuid, p_currency character varying, p_settlement_type character varying, p_counterparty_entity_id uuid) OWNER TO postgres;
...
ALTER FUNCTION kyc.check_case_doc_completion(p_case_id uuid) OWNER TO postgres;
...
ALTER FUNCTION kyc.generate_doc_requests_from_threshold(p_case_id uuid, p_batch_reference character varying) OWNER TO postgres;
...
ALTER FUNCTION kyc.is_valid_case_transition(p_from_status character varying, p_to_status character varying) OWNER TO postgres;
...
ALTER FUNCTION kyc.is_valid_doc_request_transition(p_from_status character varying, p_to_status character varying) OWNER TO postgres;
...
ALTER FUNCTION kyc.is_valid_workstream_transition(p_from_status character varying, p_to_status character varying) OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".abort_hung_sessions() OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".apply_case_decision(p_case_id uuid, p_decision character varying, p_decided_by character varying, p_notes text) OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".can_prove_ubo(p_ubo_id uuid) OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".capture_ubo_snapshot(p_cbu_id uuid, p_case_id uuid, p_snapshot_type character varying, p_reason character varying, p_captured_by character varying) OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".check_cbu_evidence_completeness(p_cbu_id uuid) OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".check_cbu_invariants() OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".check_ubo_completeness(p_cbu_id uuid, p_threshold numeric) OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".cleanup_demo_data() OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".cleanup_expired_sessions() OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".compute_case_redflag_score(p_case_id uuid) OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".compute_cbu_risk_score(target_cbu_id uuid) OWNER TO postgres;

--
-- Name: compute_ownership_chains(uuid, uuid, integer); Type: FUNCTION; Schema: ob-poc; Owner: adamtc007
--
...
ALTER FUNCTION "ob-poc".compute_ownership_chains(p_cbu_id uuid, p_target_entity_id uuid, p_max_depth integer) OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".evaluate_case_decision(p_case_id uuid, p_evaluator character varying) OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".get_attribute_value(p_entity_id uuid, p_attribute_id text) OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".get_next_version_number(domain_name_param character varying) OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".invalidate_ast_cache() OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".is_valid_cbu_transition(p_from_status character varying, p_to_status character varying) OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".is_valid_ubo_transition(p_from_status character varying, p_to_status character varying) OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".log_cbu_status_change() OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".refresh_document_type_similarities() OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".resolve_semantic_to_uuid(semantic_id text) OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".resolve_uuid_to_semantic(attr_uuid uuid) OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".set_attribute_value(p_entity_id uuid, p_attribute_id text, p_value_text text, p_value_number numeric, p_value_integer bigint, p_value_boolean boolean, p_value_date date, p_value_datetime timestamp with time zone, p_value_json jsonb, p_created_by text) OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".sync_commercial_client_role() OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".update_attribute_registry_timestamp() OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".update_timestamp() OWNER TO postgres;
...
ALTER FUNCTION "ob-poc".validate_ubo_status_transition() OWNER TO postgres;
...
ALTER FUNCTION public.ensure_entity_exists(p_entity_type_name character varying, p_entity_name character varying, p_external_id character varying) OWNER TO postgres;
...
ALTER FUNCTION public.generate_correlation_id(template text, cbu_id_val uuid, action_id_val uuid, resource_type_name text) OWNER TO postgres;
...
ALTER FUNCTION public.generate_idempotency_key(template text, resource_type_name text, environment_name text, cbu_id_val uuid, action_id_val uuid, dsl_version_id_val uuid) OWNER TO postgres;
...
ALTER FUNCTION public.get_resource_endpoint_url(resource_type_name text, lifecycle_action text, environment_name text) OWNER TO postgres;
...
ALTER TABLE custody.cbu_instrument_universe OWNER TO postgres;
...
ALTER TABLE custody.cbu_ssi OWNER TO postgres;
...
ALTER TABLE custody.cbu_ssi_agent_override OWNER TO postgres;
...
ALTER TABLE custody.cfi_codes OWNER TO postgres;
...
ALTER TABLE custody.csa_agreements OWNER TO postgres;
...
ALTER TABLE custody.entity_settlement_identity OWNER TO postgres;
...
ALTER TABLE custody.entity_ssi OWNER TO postgres;
...
ALTER TABLE custody.instruction_paths OWNER TO postgres;
...
ALTER TABLE custody.instruction_types OWNER TO postgres;
...
ALTER TABLE custody.instrument_classes OWNER TO postgres;
...
ALTER TABLE custody.isda_agreements OWNER TO postgres;
...
ALTER TABLE custody.isda_product_coverage OWNER TO postgres;
...
ALTER TABLE custody.isda_product_taxonomy OWNER TO postgres;
...
ALTER TABLE custody.markets OWNER TO postgres;
...
ALTER TABLE custody.security_types OWNER TO postgres;
...
ALTER TABLE custody.ssi_booking_rules OWNER TO postgres;
...
ALTER TABLE custody.subcustodian_network OWNER TO postgres;
...
ALTER TABLE kyc.approval_requests OWNER TO postgres;
...
ALTER TABLE kyc.case_events OWNER TO postgres;
...
ALTER TABLE kyc.cases OWNER TO postgres;
...
ALTER TABLE kyc.doc_request_acceptable_types OWNER TO postgres;
...
ALTER TABLE kyc.doc_requests OWNER TO postgres;
...
ALTER TABLE kyc.entity_workstreams OWNER TO postgres;
...
ALTER TABLE kyc.holdings OWNER TO postgres;
...
ALTER TABLE kyc.movements OWNER TO postgres;
...
ALTER TABLE kyc.red_flags OWNER TO postgres;
...
ALTER TABLE kyc.rule_executions OWNER TO postgres;
...
ALTER TABLE kyc.screenings OWNER TO postgres;
...
ALTER TABLE kyc.share_classes OWNER TO postgres;
...
ALTER VIEW kyc.v_case_summary OWNER TO postgres;
...
ALTER VIEW kyc.v_workstream_detail OWNER TO postgres;
...
ALTER TABLE "ob-poc".attribute_dictionary OWNER TO postgres;
...
ALTER TABLE "ob-poc".attribute_observations OWNER TO postgres;
...
ALTER TABLE "ob-poc".attribute_registry OWNER TO postgres;
...
ALTER TABLE "ob-poc".attribute_values_typed OWNER TO postgres;
...
ALTER SEQUENCE "ob-poc".attribute_values_typed_id_seq OWNER TO postgres;
...
ALTER TABLE "ob-poc".case_decision_thresholds OWNER TO postgres;
...
ALTER TABLE "ob-poc".case_evaluation_snapshots OWNER TO postgres;
...
ALTER TABLE "ob-poc".case_types OWNER TO postgres;
...
ALTER TABLE "ob-poc".cbu_change_log OWNER TO postgres;
...
ALTER TABLE "ob-poc".cbu_creation_log OWNER TO postgres;
...
ALTER TABLE "ob-poc".cbu_entity_roles OWNER TO postgres;
...
ALTER TABLE "ob-poc".cbu_evidence OWNER TO postgres;
...
ALTER TABLE "ob-poc".cbu_layout_overrides OWNER TO postgres;
...
ALTER TABLE "ob-poc".cbu_resource_instances OWNER TO postgres;
...
ALTER TABLE "ob-poc".cbus OWNER TO postgres;
...
ALTER TABLE "ob-poc".client_allegations OWNER TO postgres;
...
ALTER TABLE "ob-poc".client_types OWNER TO postgres;
...
ALTER TABLE "ob-poc".crud_operations OWNER TO postgres;
...
ALTER TABLE "ob-poc".csg_validation_rules OWNER TO postgres;
...
ALTER TABLE "ob-poc".currencies OWNER TO postgres;
...
ALTER TABLE "ob-poc".dictionary OWNER TO postgres;
...
ALTER TABLE "ob-poc".document_attribute_links OWNER TO postgres;
...
ALTER TABLE "ob-poc".document_attribute_mappings OWNER TO postgres;
...
ALTER TABLE "ob-poc".document_catalog OWNER TO postgres;
...
ALTER TABLE "ob-poc".document_types OWNER TO postgres;
...
ALTER TABLE "ob-poc".document_validity_rules OWNER TO postgres;
...
ALTER TABLE "ob-poc".dsl_domains OWNER TO postgres;
...
ALTER TABLE "ob-poc".dsl_examples OWNER TO postgres;
...
ALTER TABLE "ob-poc".dsl_execution_log OWNER TO postgres;
...
ALTER TABLE "ob-poc".dsl_versions OWNER TO postgres;
...
ALTER VIEW "ob-poc".dsl_execution_summary OWNER TO postgres;
...
ALTER TABLE "ob-poc".dsl_generation_log OWNER TO postgres;
...
ALTER TABLE "ob-poc".dsl_idempotency OWNER TO postgres;
...
ALTER TABLE "ob-poc".dsl_instance_versions OWNER TO postgres;
...
ALTER TABLE "ob-poc".dsl_instances OWNER TO postgres;
...
ALTER SEQUENCE "ob-poc".dsl_instances_id_seq OWNER TO postgres;
...
ALTER TABLE "ob-poc".dsl_ob OWNER TO postgres;
...
ALTER TABLE "ob-poc".dsl_session_events OWNER TO postgres;
...
ALTER TABLE "ob-poc".dsl_session_locks OWNER TO postgres;
...
ALTER TABLE "ob-poc".dsl_sessions OWNER TO postgres;
...
ALTER TABLE "ob-poc".dsl_snapshots OWNER TO postgres;
...
ALTER TABLE "ob-poc".entities OWNER TO postgres;
...
ALTER TABLE "ob-poc".entity_crud_rules OWNER TO postgres;
...
ALTER TABLE "ob-poc".entity_limited_companies OWNER TO postgres;
...
ALTER TABLE "ob-poc".entity_partnerships OWNER TO postgres;
...
ALTER TABLE "ob-poc".entity_proper_persons OWNER TO postgres;
...
ALTER TABLE "ob-poc".entity_trusts OWNER TO postgres;
...
ALTER VIEW "ob-poc".entity_search_view OWNER TO postgres;
...
ALTER TABLE "ob-poc".entity_types OWNER TO postgres;
...
ALTER TABLE "ob-poc".entity_validation_rules OWNER TO postgres;
...
ALTER TABLE "ob-poc".master_jurisdictions OWNER TO postgres;
...
ALTER VIEW "ob-poc".jurisdictions OWNER TO postgres;
...
ALTER TABLE "ob-poc".master_entity_xref OWNER TO postgres;
...
ALTER TABLE "ob-poc".observation_discrepancies OWNER TO postgres;
...
ALTER TABLE "ob-poc".onboarding_products OWNER TO postgres;
...
ALTER TABLE "ob-poc".onboarding_requests OWNER TO postgres;
...
ALTER TABLE "ob-poc".ownership_relationships OWNER TO postgres;
...
ALTER TABLE "ob-poc".product_services OWNER TO postgres;
...
ALTER TABLE "ob-poc".products OWNER TO postgres;
...
ALTER TABLE "ob-poc".red_flag_severities OWNER TO postgres;
...
ALTER TABLE "ob-poc".redflag_score_config OWNER TO postgres;
...
ALTER TABLE "ob-poc".requirement_acceptable_docs OWNER TO postgres;
...
ALTER TABLE "ob-poc".resource_attribute_requirements OWNER TO postgres;
...
ALTER TABLE "ob-poc".resource_instance_attributes OWNER TO postgres;
...
ALTER TABLE "ob-poc".risk_bands OWNER TO postgres;
...
ALTER TABLE "ob-poc".risk_ratings OWNER TO postgres;
...
ALTER TABLE "ob-poc".roles OWNER TO postgres;
...
ALTER TABLE "ob-poc".schema_changes OWNER TO postgres;
...
ALTER TABLE "ob-poc".screening_lists OWNER TO postgres;
...
ALTER TABLE "ob-poc".screening_requirements OWNER TO postgres;
...
ALTER TABLE "ob-poc".screening_types OWNER TO postgres;
...
ALTER TABLE "ob-poc".service_delivery_map OWNER TO postgres;
...
ALTER TABLE "ob-poc".service_option_choices OWNER TO postgres;
...
ALTER TABLE "ob-poc".service_option_definitions OWNER TO postgres;
...
ALTER TABLE "ob-poc".service_resource_capabilities OWNER TO postgres;
...
ALTER TABLE "ob-poc".service_resource_types OWNER TO postgres;
...
ALTER TABLE "ob-poc".services OWNER TO postgres;
...
ALTER TABLE "ob-poc".settlement_types OWNER TO postgres;
...
ALTER TABLE "ob-poc".ssi_types OWNER TO postgres;
...
ALTER TABLE "ob-poc".taxonomy_crud_log OWNER TO postgres;
...
ALTER TABLE "ob-poc".threshold_factors OWNER TO postgres;
...
ALTER TABLE "ob-poc".threshold_requirements OWNER TO postgres;
...
ALTER TABLE "ob-poc".trust_parties OWNER TO postgres;
...
ALTER TABLE "ob-poc".ubo_evidence OWNER TO postgres;
...
ALTER TABLE "ob-poc".ubo_registry OWNER TO postgres;
...
ALTER TABLE "ob-poc".ubo_snapshot_comparisons OWNER TO postgres;
...
ALTER TABLE "ob-poc".ubo_snapshots OWNER TO postgres;
...
ALTER VIEW "ob-poc".v_allegation_summary OWNER TO postgres;
...
ALTER VIEW "ob-poc".v_attribute_current OWNER TO postgres;
...
ALTER VIEW "ob-poc".v_case_redflag_summary OWNER TO postgres;
...
ALTER VIEW "ob-poc".v_cbu_entity_graph OWNER TO postgres;
...
ALTER VIEW "ob-poc".v_cbu_entity_with_roles OWNER TO postgres;
...
ALTER VIEW "ob-poc".v_cbu_investor_details OWNER TO postgres;
...
ALTER VIEW "ob-poc".v_cbu_investor_groups OWNER TO postgres;
...
ALTER VIEW "ob-poc".v_cbu_kyc_summary OWNER TO postgres;
...
ALTER VIEW "ob-poc".v_cbu_lifecycle OWNER TO postgres;
...
ALTER VIEW "ob-poc".v_cbu_validation_summary OWNER TO postgres;
...
ALTER VIEW "ob-poc".v_document_extraction_map OWNER TO postgres;
...
ALTER VIEW "ob-poc".v_open_discrepancies OWNER TO postgres;
...
ALTER VIEW "ob-poc".v_ubo_evidence_summary OWNER TO postgres;
...
ALTER TABLE "ob-poc".workstream_statuses OWNER TO postgres;
...
ALTER TABLE public.attribute_sources OWNER TO postgres;
...
ALTER SEQUENCE public.attribute_sources_id_seq OWNER TO postgres;
...
ALTER TABLE public.business_attributes OWNER TO postgres;
...
ALTER SEQUENCE public.business_attributes_id_seq OWNER TO postgres;
...
ALTER TABLE public.data_domains OWNER TO postgres;
...
ALTER SEQUENCE public.data_domains_id_seq OWNER TO postgres;
...
ALTER TABLE public.derived_attributes OWNER TO postgres;
...
ALTER SEQUENCE public.derived_attributes_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.rule_categories_id_seq OWNER TO postgres;
...
ALTER TABLE public.rule_dependencies OWNER TO postgres;
...
ALTER SEQUENCE public.rule_dependencies_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.rule_versions_id_seq OWNER TO postgres;
