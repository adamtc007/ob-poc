...
export type TradingMatrixNodeType =
  ...
  | {
      ...
      ssi_type: string;
      status: string;
      safekeeping_account?: string;
      safekeeping_bic?: string;
      cash_account?: string;
      cash_bic?: string;
      pset_bic?: string;
  ...
  | {
      type: "investment_manager_mandate";
      mandate_id: string;
  ...
  | {
      type: "corporate_actions_policy";
      enabled_count: number;
      has_custom_elections: boolean;
      has_cutoff_rules: boolean;
      elector?: string;
    }
  | {
      type: "ca_event_type_config";
      event_code: string;
      event_name: string;
 ...
 */
export async function getTradingMatrix(
  cbuId: string,
): Promise<TradingMatrixResponse> {
...
export function getNodeTypeLabel(nodeType: TradingMatrixNodeType): string {
  switch (nodeType.type) {
    ...
    case "instrument_class":
      return nodeType.is_otc
        ? "OTC Instrument Class"
        : "Exchange Instrument Class";
    case "market":
      return "Market";
    case "counterparty":
      return "Counterparty";
