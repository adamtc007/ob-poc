...
// `StewardshipDispatch` trait; bridges to
...
// `ConstellationRuntime`; bridges to
...
// `SemOsContextResolver`; bridges to
...
// `SessionService`; single-method dispatch
...
// `ServicePipelineService`; multi-domain
...
// `PhraseService`; single-method dispatch
