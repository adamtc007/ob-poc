...
use crate::repl::runbook::{EntryStatus, Runbook, RunbookEntry, RunbookEvent, SlotSource};
...
use crate::sequencer::{rebuild_dsl, NullDslExecutor, ReplOrchestratorV2};
...
fn test_readiness_reports_issues() {
    ...
    entry
        .unresolved_refs
        .push(crate::repl::runbook::UnresolvedRef {
