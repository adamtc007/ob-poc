...
mod integration {
    ...
    async fn test_scenario8_onboarding_pipeline_full_round_trip() -> Result<()> {
        ...
        use crate::sem_reg::evidence::{EvidenceRequirementBody, RequiredDocument};
        use crate::sem_reg::onboarding::{OnboardingPipeline, OnboardingRequest};
    ...
    async fn test_scenario9_gate_unification() -> Result<()> {
        ...
        let body_a = AttributeDefBody {
            ...
            domain: "gate".into(),
            data_type: crate::sem_reg::attribute_def::AttributeDataType::String,
            evidence_grade: EvidenceGrade::None,
            source: None,
            constraints: None,
            sinks: vec![],
