...
use crate::repl::intent_service::IntentService;
use crate::repl::proposal_engine::{ProposalEngine, ProposalSource, StepProposal};
    ...
    fn matched(verb: &str, confidence: f32, dsl: Option<&str>) -> Self {
        Self {
            result: IntentMatchResult {
                ...
                verb_candidates: vec![crate::repl::types::VerbCandidate {
        ...
        Self {
            result: IntentMatchResult {
                ...
                verb_candidates: candidates
                    .into_iter()
                    .map(|(v, s)| crate::repl::types::VerbCandidate {
...
fn empty_context_stack(runbook: &crate::repl::runbook::Runbook) -> ContextStack {
...
async fn test_direct_dsl_produces_single_proposal() {
    ...
    let runbook = crate::repl::runbook::Runbook::new(Uuid::new_v4());
...
async fn test_pack_allowed_verbs_filtering() {
    use crate::repl::proposal_engine::filter_by_pack_constraints;
...
async fn test_template_proposals_boosted() {
    let boost = crate::repl::proposal_engine::TEMPLATE_CONFIDENCE_BOOST;
...
fn make_proposal(verb: &str, confidence: f32) -> StepProposal {
    use crate::repl::proposal_engine::ProposalEvidence;
