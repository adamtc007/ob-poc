...
use super::helpers::{
    get_required_uuid, json_extract_string_opt, json_extract_uuid, json_extract_uuid_opt,
...
impl CapitalShareClassCreateOp {
    #[cfg(feature = "database")]
    async fn execute(
        &self,
        verb_call: &VerbCall,
...
impl CapitalShareClassGetSupplyOp {
    #[cfg(feature = "database")]
    async fn execute(
        &self,
        verb_call: &VerbCall,
