...
impl CustomOperation for DealCreateOp {
    ...
    async fn execute_json(
        ...
        Ok(dsl_runtime::VerbExecutionOutcome::Uuid(deal_id))
    }
...
impl DealUpdateProductStatusOp {
    #[cfg(feature = "database")]
    async fn execute(
        &self,
        verb_call: &VerbCall,
...
impl CustomOperation for DealAddRateCardLineOp {
    ...
    async fn execute_json(
        ...
        Ok(dsl_runtime::VerbExecutionOutcome::Uuid(line_id))
    }
...
impl CustomOperation for DealAddSlaOp {
    ...
    async fn execute_json(
        ...
        Ok(dsl_runtime::VerbExecutionOutcome::Uuid(sla_id))
    }
...
impl DealUpdateDocumentStatusOp {
    #[cfg(feature = "database")]
    async fn execute(
        &self,
        verb_call: &VerbCall,
...
impl DealUpdateUboAssessmentOp {
    #[cfg(feature = "database")]
    async fn execute(
        &self,
        verb_call: &VerbCall,
...
impl DealRequestOnboardingBatchOp {
    #[cfg(feature = "database")]
    async fn execute(
        &self,
        verb_call: &VerbCall,
...
impl DealUpdateOnboardingStatusOp {
    #[cfg(feature = "database")]
    async fn execute(
        &self,
        verb_call: &VerbCall,
