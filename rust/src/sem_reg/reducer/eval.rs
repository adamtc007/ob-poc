...
impl<'a> ConditionEvaluator<'a> {
    ...
    /// ```rust
    /// use std::collections::HashMap;
    /// use ob_poc::sem_reg::reducer::{ConditionBody, ConditionEvaluator};
    ///
    ...
    /// ```rust
    /// use std::collections::HashMap;
    /// use ob_poc::sem_reg::reducer::{ConditionBody, ConditionEvaluator, ScopeData, SlotOverlayData};
    ///
    /// let asts = HashMap::<String, ConditionBody>::new();
    /// let order = Vec::<String>::new();
...
/// ```rust
/// use std::collections::HashMap;
/// use ob_poc::sem_reg::reducer::{evaluate_rules, RuleDef};
///
...
impl ValidatedStateMachine {
    ...
    /// ```rust
    /// use std::collections::HashMap;
    /// use ob_poc::sem_reg::reducer::{ConditionBody, ScopeData, SlotOverlayData, ValidatedStateMachine};
    ///
