...
pub struct DomainVocabularyManager {
...
impl DomainVocabularyManager {
    ...
    pub fn add_vocabulary_to_domain(
        &mut self,
        domain_name: &str,
    ...
    pub fn get_domain_vocabulary(&self, domain_name: &str) -> Option<&Vec<VocabularyVerb>> {
    ...
    /// Get domain metadata
    pub fn get_domain_metadata(&self, domain_name: &str) -> Option<&DomainMetadata> {
        self.domain_metadata.get(domain_name)
    }

    /// Remove domain
    pub fn remove_domain(&mut self, domain_name: &str) -> Result<(), VocabularyError> {
        if !self.domain_metadata.contains_key(domain_name) {
    ...
    pub fn check_cross_domain_conflicts(&self) -> Vec<ConflictReport> {
    ...
    pub fn get_domain_statistics(&self) -> HashMap<String, DomainStats> {
