...
const KYC_UPDATE_STATUS_TASK: &str = "kyc-case.update-status";
const DEAL_UPDATE_STATUS_TASK: &str = "deal.update-status";
const DEAL_PACK_ID: &str = "deal.lifecycle";
const DEAL_PACK_VERSION: &str = "1.0";
const DEAL_STATE_MACHINE: &str = "deal_commercial_lifecycle";
...
impl AcpPromptStateAnchorProviderReport {
    ...
    pub(crate) fn metrics(&self, result: Option<&Value>) -> Value {
...
pub(crate) enum AcpPromptStateAnchorProviderOutcome {
    Continue {
...
impl AcpPromptStateAnchorProviderOutcome {
    pub(crate) fn continue_without_provider() -> Self {
        Self::Continue {
            outgoing: Vec::new(),
...
struct DealTransitionSpec {
    transition_ref: &'static str,
    from_state: &'static str,
    to_state: &'static str,
}

const DEAL_UPDATE_STATUS_TRANSITIONS: &[DealTransitionSpec] = &[
    DealTransitionSpec {
