...
impl DslBuilder {
    ...
    pub fn service_create(&mut self) -> ServiceCreateBuilder {
        ServiceCreateBuilder::new(self)
    }
    
    /// Add a service.read statement
    pub fn service_read(&mut self, service_id: &str) -> &mut Self {
        self.statements.push(format!("(service.read :service-id \"{}\")", service_id));
        self
    }
    
    /// Add a service.delete statement
    pub fn service_delete(&mut self, service_id: &str) -> &mut Self {
        self.statements.push(format!("(service.delete :service-id \"{}\")", service_id));
        self
    }
    
    /// Link a service to a product
    pub fn service_link_product(&mut self, service_id: &str, product_id: &str, is_mandatory: bool) -> &mut Self {
    ...
    pub fn lifecycle_resource_create(&mut self) -> ResourceCreateBuilder {
    ...
    pub fn lifecycle_resource_read(&mut self, resource_id: &str) -> &mut Self {
        self.statements.push(format!("(lifecycle-resource.read :resource-id \"{}\")", resource_id));
        self
    }
    
    /// Add a lifecycle-resource.delete statement
    pub fn lifecycle_resource_delete(&mut self, resource_id: &str) -> &mut Self {
        self.statements.push(format!("(lifecycle-resource.delete :resource-id \"{}\")", resource_id));
        self
    }
    
    /// Link a resource to a service
    pub fn lifecycle_resource_link_service(&mut self, resource_id: &str, service_id: &str) -> &mut Self {
        self.statements.push(format!(
