...
pub const READ_CLUE_WORDS: &[&str] = &[
    "show", "list", "what", "who", "find", "trace", "describe", "get", "fetch",
    "display", "view", "search", "check", "tell", "how many", "how does",
    "which", "where", "when", "count", "summarize", "summary", "inspect",
    "explain", "look", "lookup", "query", "read", "report", "explore",
];

/// Write-intent clue words — utterance starts with one of these → Write polarity.
pub const WRITE_CLUE_WORDS: &[&str] = &[
    "create", "add", "make", "new", "set up", "setup", "build", "generate",
    "update", "edit", "change", "modify", "rename", "move", "set",
    "delete", "remove", "drop", "archive", "retire", "deprecate",
    "import", "sync", "load", "push", "publish", "deploy",
    "assign", "attach", "link", "register", "enroll", "onboard",
    "approve", "reject", "submit", "propose", "flag",
];

/// Ambiguous clue words — require more context to determine polarity.
pub const AMBIGUOUS_CLUE_WORDS: &[&str] = &[
    "run", "execute", "process", "handle", "manage", "review",
    "validate", "verify", "confirm", "analyze", "analyse",
];
