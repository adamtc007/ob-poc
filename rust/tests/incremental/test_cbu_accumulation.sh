...
(entity.create :entity-type "limited-company" :name "Test Holdings Ltd" :jurisdiction "LU" :as @company)' "CBU + Entity"

echo "=== TEST 4: Re-run CBU + Entity (idempotent) ==="
run_dsl '(cbu.ensure :name "Incremental Test Fund" :jurisdiction "LU" :client-type "fund" :as @cbu)
(entity.create :entity-type "limited-company" :name "Test Holdings Ltd" :jurisdiction "LU" :as @company)' "Re-run CBU + Entity"

echo "=== TEST 5: CBU + Entity + Role ==="
run_dsl '(cbu.ensure :name "Incremental Test Fund" :jurisdiction "LU" :client-type "fund" :as @cbu)
(entity.create :entity-type "limited-company" :name "Test Holdings Ltd" :jurisdiction "LU" :as @company)
...
(entity.create :entity-type "proper-person" :first-name "John" :last-name "Smith" :date-of-birth "1980-01-15" :as @john)' "Add person"
