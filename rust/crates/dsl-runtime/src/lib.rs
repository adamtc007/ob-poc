...
pub use cross_workspace::{
 ...
 supersede_call, transition_lifecycle,
    ...
    CompensationSummary, ConditionResult, ConsumerRefStatus, CorrectionType,
    CreateRemediationInput, DerivedStateEvaluator, DerivedStateProjection, DerivedStateProjector,
    DerivedStateValue, ExternalCallRow, GateChecker, IdempotencyAction, LifecycleTransitionResult,
    NoChildrenResolver, PlatformDag, PlatformEdge, PostgresChildEntityResolver,
    PostgresSlotStateProvider, PredicateResolver, PropagationResult, ProviderCapability,
    ProviderCapabilitySummary, RebuildContext, RecordCallInput, RecordCompensationInput,
    RegisterSharedAtomInput, RemediationEventRow, RemediationEventSummary, RemediationStatus,
    ReplayOutcome, ReplayResult, ReplayTrigger, SameEntityResolver, SharedAtomDef,
    SharedAtomLifecycle, SharedAtomSummary, SharedAtomValidation, SharedFactVersionRow,
    SharedFactVersionSummary, SlotStateProvider, SqlPredicateResolver, StaleConsumerRef,
    StaleSharedFactRef, WorkspaceFactRefRow,
};
