...
impl<'a> ConditionEvaluator<'a> {
    ...
    /// ```rust
    /// use std::collections::HashMap;
    /// use dsl_runtime::{ConditionBody, ConditionEvaluator};
    ///
    ...
    /// ```rust
    /// use std::collections::HashMap;
    /// use dsl_runtime::{ConditionBody, ConditionEvaluator, ScopeData, SlotOverlayData};
    ///
    /// let asts = HashMap::<String, ConditionBody>::new();
    /// let order = Vec::<String>::new();
...
/// ```rust
/// use std::collections::HashMap;
/// use dsl_runtime::{evaluate_rules, RuleDef};
///
...
impl ValidatedStateMachine {
    ...
    /// ```rust
    /// use std::collections::HashMap;
    /// use dsl_runtime::{ConditionBody, ScopeData, SlotOverlayData, ValidatedStateMachine};
    ///
