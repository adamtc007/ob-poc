//! Pure taxonomy seed builders for the semantic registry.
//!
//! All functions are **pure** (no DB, no I/O). The DB-publishing orchestrator
//! remains in `ob-poc/src/sem_reg/seeds/taxonomy_seeds.rs`.
...
pub fn core_taxonomies() -> Vec<(TaxonomyDefBody, Vec<TaxonomyNodeBody>)> {
    vec![
...
pub fn entity_classification_taxonomy() -> (TaxonomyDefBody, Vec<TaxonomyNodeBody>) {
...
pub fn jurisdiction_taxonomy() -> (TaxonomyDefBody, Vec<TaxonomyNodeBody>) {
    let tax = TaxonomyDefBody {
...
pub fn instrument_taxonomy() -> (TaxonomyDefBody, Vec<TaxonomyNodeBody>) {
    let tax = TaxonomyDefBody {
...
pub fn governance_tier_taxonomy() -> (TaxonomyDefBody, Vec<TaxonomyNodeBody>) {
    let tax = TaxonomyDefBody {
...
pub fn domain_taxonomy() -> (TaxonomyDefBody, Vec<TaxonomyNodeBody>) {
    let tax = TaxonomyDefBody {
...
pub fn subject_category_taxonomy() -> (TaxonomyDefBody, Vec<TaxonomyNodeBody>) {
    let tax = TaxonomyDefBody {
...
pub fn risk_tier_taxonomy() -> (TaxonomyDefBody, Vec<TaxonomyNodeBody>) {
    let tax = TaxonomyDefBody {
...
pub fn document_class_taxonomy() -> (TaxonomyDefBody, Vec<TaxonomyNodeBody>) {
    let tax = TaxonomyDefBody {
...
pub fn jurisdiction_regime_taxonomy() -> (TaxonomyDefBody, Vec<TaxonomyNodeBody>) {
    let tax = TaxonomyDefBody {
