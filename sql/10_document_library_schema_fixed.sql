-- 10_document_library_schema_fixed.sql
-- Document Library Infrastructure with Proper AttributeID Integration
--
...
('docf0001-0000-0000-0000-000000000001', 'document.passport.number', 'Passport number', 'Document', 'string', 'Identity', '{"type": "extraction", "required": true}', '{"type": "database", "table": "document_catalog"}', NOW(), NOW()),
('docf0001-0000-0000-0000-000000000002', 'document.passport.full_name', 'Full name on passport', 'Document', 'string', 'Identity', '{"type": "extraction", "required": true}', '{"type": "database", "table": "document_catalog"}', NOW(), NOW()),
('docf0001-0000-0000-0000-000000000003', 'document.passport.nationality', 'Passport nationality', 'Document', 'string', 'Identity', '{"type": "extraction", "required": true, "format": "ISO-3166-1"}', '{"type": "database", "table": "document_catalog"}', NOW(), NOW()),
('docf0001-0000-0000-0000-000000000004', 'document.passport.date_of_birth', 'Date of birth on passport', 'Document', 'date', 'Identity', '{"type": "extraction", "required": true}', '{"type": "database", "table": "document_catalog"}', NOW(), NOW()),
('docf0001-0000-0000-0000-000000000005', 'document.passport.issue_date', 'Passport issue date', 'Document', 'date', 'Identity', '{"type": "extraction", "required": true}', '{"type": "database", "table": "document_catalog"}', NOW(), NOW()),
('docf0001-0000-0000-0000-000000000006', 'document.passport.expiry_date', 'Passport expiry date', 'Document', 'date', 'Identity', '{"type": "extraction", "required": true}', '{"type": "database", "table": "document_catalog"}', NOW(), NOW()),

-- Corporate Document Fields
('docf0002-0000-0000-0000-000000000001', 'document.incorporation.company_name', 'Company name on incorporation document', 'Document', 'string', 'Corporate', '{"type": "extraction", "required": true}', '{"type": "database", "table": "document_catalog"}', NOW(), NOW()),
('docf0002-0000-0000-0000-000000000002', 'document.incorporation.registration_number', 'Company registration number', 'Document', 'string', 'Corporate', '{"type": "extraction", "required": true}', '{"type": "database", "table": "document_catalog"}', NOW(), NOW()),
('docf0002-0000-0000-0000-000000000003', 'document.incorporation.incorporation_date', 'Date of incorporation', 'Document', 'date', 'Corporate', '{"type": "extraction", "required": true}', '{"type": "database", "table": "document_catalog"}', NOW(), NOW()),
('docf0002-0000-0000-0000-000000000004', 'document.incorporation.jurisdiction', 'Jurisdiction of incorporation', 'Document', 'string', 'Corporate', '{"type": "extraction", "required": true, "format": "ISO-3166-1"}', '{"type": "database", "table": "document_catalog"}', NOW(), NOW()),
('docf0002-0000-0000-0000-000000000005', 'document.incorporation.authorized_shares', 'Number of authorized shares', 'Document', 'integer', 'Corporate', '{"type": "extraction", "required": false}', '{"type": "database", "table": "document_catalog"}', NOW(), NOW()),

-- Financial Document Fields
('docf0003-0000-0000-0000-000000000001', 'document.bank_statement.account_holder', 'Account holder name', 'Document', 'string', 'Financial', '{"type": "extraction", "required": true}', '{"type": "database", "table": "document_catalog"}', NOW(), NOW()),
('docf0003-0000-0000-0000-000000000002', 'document.bank_statement.account_number', 'Bank account number', 'Document', 'string', 'Financial', '{"type": "extraction", "required": true}', '{"type": "database", "table": "document_catalog"}', NOW(), NOW()),
('docf0003-0000-0000-0000-000000000003', 'document.bank_statement.statement_date', 'Statement date', 'Document', 'date', 'Financial', '{"type": "extraction", "required": true}', '{"type": "database", "table": "document_catalog"}', NOW(), NOW()),
('docf0003-0000-0000-0000-000000000004', 'document.bank_statement.opening_balance', 'Opening balance', 'Document', 'decimal', 'Financial', '{"type": "extraction", "required": false}', '{"type": "database", "table": "document_catalog"}', NOW(), NOW()),
('docf0003-0000-0000-0000-000000000005', 'document.bank_statement.closing_balance', 'Closing balance', 'Document', 'decimal', 'Financial', '{"type": "extraction", "required": false}', '{"type": "database", "table": "document_catalog"}', NOW(), NOW())
...
-- Foreign key constraints to ensure AttributeID integrity
ALTER TABLE "ob-poc".document_types
    ADD CONSTRAINT fk_document_types_primary_attr
    FOREIGN KEY (primary_attribute_id) REFERENCES "ob-poc".dictionary (attribute_id) ON DELETE RESTRICT;
...
CREATE TABLE IF NOT EXISTS "ob-poc".document_catalog (
    ...
    -- Ensure extracted attributes reference valid AttributeIDs
    CONSTRAINT chk_extracted_attributes_valid CHECK (
        extracted_attributes IS NULL OR
        (SELECT COUNT(*) FROM jsonb_object_keys(extracted_attributes) key
         WHERE key::uuid NOT IN (SELECT attribute_id FROM "ob-poc".dictionary)) = 0
    )
);
...
-- ============================================================================
-- SEED DATA WITH ATTRIBUTEID REFERENCES
-- ============================================================================

-- Core document types with proper AttributeID linkage
...
('passport', 'Passport', 'identity', 'kyc',
 ...
 ARRAY['docf0001-0000-0000-0000-000000000001'::uuid, 'docf0001-0000-0000-0000-000000000002'::uuid, 'docf0001-0000-0000-0000-000000000003'::uuid],
 ARRAY['docf0001-0000-0000-0000-000000000001'::uuid, 'docf0001-0000-0000-0000-000000000002'::uuid],
...
('certificate_incorporation', 'Certificate of Incorporation', 'corporate', 'kyc',
 ...
 ARRAY['docf0002-0000-0000-0000-000000000001'::uuid, 'docf0002-0000-0000-0000-000000000002'::uuid, 'docf0002-0000-0000-0000-000000000003'::uuid],
 ARRAY['docf0002-0000-0000-0000-000000000001'::uuid, 'docf0002-0000-0000-0000-000000000002'::uuid],
...
('bank_statement', 'Bank Statement', 'financial', 'kyc',
 ...
 ARRAY['docf0003-0000-0000-0000-000000000001'::uuid, 'docf0003-0000-0000-0000-000000000002'::uuid, 'docf0003-0000-0000-0000-000000000003'::uuid],
 ARRAY['docf0003-0000-0000-0000-000000000001'::uuid, 'docf0003-0000-0000-0000-000000000004'::uuid, 'docf0003-0000-0000-0000-000000000005'::uuid],
...
('cayman_registry', 'Cayman Islands General Registry', 'KY', 'government', 'national', ARRAY['certificate_incorporation']),
('sg_acra', 'Accounting and Corporate Regulatory Authority', 'SG', 'regulatory_body', 'national', ARRAY['certificate_incorporation']),
('uk_companies_house', 'Companies House', 'GB', 'government', 'national', ARRAY['certificate_incorporation']);
...
-- ============================================================================
-- ATTRIBUTEID VALIDATION FUNCTIONS
-- ============================================================================
...
BEGIN
    ...
    SELECT array_agg(attr) INTO missing_attrs
    FROM unnest(expected_attrs) attr
    WHERE attr::text NOT IN (SELECT unnest(extracted_keys));
    ...
    -- Return false if there are missing required attributes or invalid attributes
    IF array_length(missing_attrs, 1) > 0 OR array_length(unexpected_attrs, 1) > 0 THEN
        RAISE WARNING 'Document validation failed. Missing attrs: %, Invalid attrs: %', missing_attrs, unexpected_attrs;
        RETURN false;
    END IF;
...
-- Document library schema with full AttributeID integration is now complete
