...
\restrict vhI1OG8cTzKG5tSXXMGkL9ifz16BqmQzdUcDHoAkKDTdHLpCgzGr3Xz0HigfDJf
...
--
-- Name: idx_prod_resources_is_active; Type: INDEX; Schema: ob-poc; Owner: adamtc007
--
...
--
-- Name: idx_prod_resources_resource_code; Type: INDEX; Schema: ob-poc; Owner: adamtc007
--
...
--
-- Name: TABLE prod_resources; Type: ACL; Schema: ob-poc; Owner: adamtc007
--

GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE "ob-poc".prod_resources TO PUBLIC;
...
\unrestrict vhI1OG8cTzKG5tSXXMGkL9ifz16BqmQzdUcDHoAkKDTdHLpCgzGr3Xz0HigfDJf
