-- 09_populate_semantic_verbs.sql
-- Phase 3: Populate Semantic Verb Registry with Rich Metadata
--
...
('onboarding', 'case.create',
 ...
 ARRAY['Valid CBU identifier available', 'Nature/purpose defined by business'],
...
('workflow', 'workflow.transition',
 ...
 'state_management',
 ARRAY['Variable - depends on current state'],
 ARRAY['Variable - depends on target state'],
