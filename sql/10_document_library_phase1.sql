-- 10_document_library_phase1.sql
-- Document Library Infrastructure - Phase 1 Implementation
--
...
('passport', 'Passport', 'identity', 'kyc',
 ...
 ARRAY['d0cf0001-0000-0000-0000-000000000001', 'd0cf0001-0000-0000-0000-000000000002', 'd0cf0001-0000-0000-0000-000000000003'],
 ARRAY['d0cf0001-0000-0000-0000-000000000001', 'd0cf0001-0000-0000-0000-000000000002'],
...
('certificate_incorporation', 'Certificate of Incorporation', 'corporate', 'kyc',
 ...
 ARRAY['d0cf0002-0000-0000-0000-000000000001', 'd0cf0002-0000-0000-0000-000000000002', 'd0cf0002-0000-0000-0000-000000000003'],
 ARRAY['d0cf0002-0000-0000-0000-000000000001', 'd0cf0002-0000-0000-0000-000000000002'],
...
('bank_statement', 'Bank Statement', 'financial', 'kyc',
 ...
 ARRAY['d0cf0003-0000-0000-0000-000000000001', 'd0cf0003-0000-0000-0000-000000000002', 'd0cf0003-0000-0000-0000-000000000003'],
 ARRAY['d0cf0003-0000-0000-0000-000000000001', 'd0cf0003-0000-0000-0000-000000000004', 'd0cf0003-0000-0000-0000-000000000005'],
...
('doc-passport-john-001',
 ...
 (SELECT issuer_id FROM "ob-poc".document_issuers WHERE issuer_code = 'us_state_dept'),
...
('doc-cayman-registry-001',
 ...
 (SELECT issuer_id FROM "ob-poc".document_issuers WHERE issuer_code = 'cayman_registry'),
